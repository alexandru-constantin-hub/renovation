...
namespace Renovation.Controllers
{
    public class AnnouncesController : Controller
    {
        ...
        public AnnouncesController(RenovationContext context)
        {
            _context = context;
        }
        ...
        {
            var renovationContext = _context.Announces.Include(a => a.IdDesactivateurNavigation).Include(a => a.IdPieceNavigation).Include(a => a.IdTypeRenovationNavigation).Include(a => a.IdUtilisateurNavigation);
        ...
        {
            ViewData["IdDesactivateur"] = new SelectList(_context.Administrators, "IdAdministrator", "IdAdministrator");
        ...
        public async Task<IActionResult> Create([Bind("IdAnnounce,Adresse,Duree,Dimensione,AutreInformation,Etat,IdUtilisateur,IdPiece,IdTypeRenovation,IdDesactivateur")] Announce announce)
        {
            ...
            ViewData["IdDesactivateur"] = new SelectList(_context.Administrators, "IdAdministrator", "IdAdministrator", announce.IdDesactivateur);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAnnounce,Adresse,Duree,Dimensione,AutreInformation,Etat,IdUtilisateur,IdPiece,IdTypeRenovation,IdDesactivateur")] Announce announce)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RenovationContext.Announces'  is null.");
            }
            var announce = await _context.Announces.FindAsync(id);
            if (announce != null)
            {
