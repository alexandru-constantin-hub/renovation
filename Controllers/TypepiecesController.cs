...
namespace Renovation.Controllers
{
    public class TypepiecesController : Controller
    {
        ...
        public TypepiecesController(RenovationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPiece,Titre,Description")] Typepiece typepiece)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RenovationContext.Typepieces'  is null.");
            }
            var typepiece = await _context.Typepieces.FindAsync(id);
            if (typepiece != null)
            {
